 ...
 * Time: 11:18
 */
public abstract class BaseInterfaceFragment<P extends BasePresenter<?, ?>>
    ...
    public void showLoadingDialog(String msg) {
        iDelegate.showLoadingDialog(getActivity(), msg);
    }

    public void showLoadingDialog() {
       /* iDelegate.showLoadingDialog(getActivity());*/
    ...
    public void showNetworkAnomaly(String msg){
