...
public class LoggingInterceptor implements Interceptor {
    ...
    public static class Builder {
        ...
        String getTag(boolean isRequest) {
            if (isRequest) {
                return CheckUtil.isEmpty(requestTag) ? TAG : requestTag;
            } else {
                return CheckUtil.isEmpty(responseTag) ? TAG : responseTag;
            }
        }
    ...
    private boolean isEmpty(String line) {
        return CheckUtil.isEmpty(line) || N.equals(line) || T.equals(line) || CheckUtil.isEmpty(line.trim());
    }

    private void printJsonRequest(LoggingInterceptor.Builder builder, Request request) {
